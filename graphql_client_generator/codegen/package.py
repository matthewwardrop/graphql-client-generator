...
def generate_init(
    ...
    if regen_command:
        ...
        docstring = f'"""GraphQL client package generated by `graphql_client_generator`: {package_name}."""'

    lines = [
        docstring,
        "",
        f"from .client import {client_class_name}",
        f"from .schema import {schema_class_name}",
        "from . import enums",
        "from . import inputs",
        "from . import outputs",
        "from . import schema",
        ...
        "",
        f"__all__ = [{client_class_name!r}, {schema_class_name!r}, 'Variable', 'enums', 'inputs', 'outputs', 'schema']",
        "",
    ]
    return "\n".join(lines)
